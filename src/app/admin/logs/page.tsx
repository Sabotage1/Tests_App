...
const ENTITY_FILTERS = [
  ...
  { value: "recipient_list", label: "רשימות נבחנים" },
...
const ACTION_LABELS: Record<string, string> = {
  ...
  "recipient_list.created": "יצירת רשימה",
  "recipient_list.deleted": "מחיקת רשימה",
  "recipient_list.updated": "עדכון רשימה",
...
const DETAIL_LABELS: Record<string, string> = {
  ...
  lookupType: "סוג ערך",
  memberCount: "כמות נבחנים",
  passwordReset: "איפוס סיסמה",
  questionCount: "כמות שאלות",
  recipientListId: "מזהה רשימה",
  recipientListName: "שם רשימה",
